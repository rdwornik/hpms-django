...
class ActivityTable(tables.Table):
    ...
    visits_count    =   tables.Column(attrs={"td" : {"align" : "center"}})
...
class NotesTable(tables.Table):
    selection   =   tables.CheckBoxColumn(accessor="pk",
                                          attrs={"td" : {"align" : "center"}, 
                                                 "th" : {"style" : "width: 2%"},
                                                 "td__input" : {"name" : "selected_notes"},
                                                 "th__input" : {"type" : "hidden"}})
    title       =   tables.LinkColumn("all_notes_edit", 
                                      text=lambda record: record.title, 
                                      args=[A("pk")],
                                      attrs={"th" : {"style" : "width: 18%"}})
    
    transaction =   tables.Column(attrs={"td" : {"align" : "center"},
                                         "th" : {"style" : "width: 5%"}})
    visitor_ip  =   tables.Column(attrs={"th" : {"style" : "width: 25%"}})
    content     =   tables.Column(attrs={"th" : {"style" : "width: 50%"}})
    class Meta:
...
class VisitorTable(tables.Table):
    ...
    class Meta:
        ...
        attrs       = {"class": "table table-striped","style":"width: 60%"} 
        
class TagsTable(tables.Table):
    id              = tables.Column(visible=False)
    name_cryteria   = tables.Column(attrs={"td" : {"style" : "word-break: break-all"},
                                           "th" : {"style" : "width: 28%"}})
    value_cryteria  = tables.Column(attrs={"td" : {"style" : "word-break: break-all"},
                                           "th" : {"style" : "width: 20%"}})
    description     = tables.Column(attrs={"td" : {"style" : "word-break: break-all"},
                                           "th" : {"style" : "width: 38%"}})
    tag             = tables.LinkColumn("tags_edit",
                                        text=lambda value: value,
                                        args=[A("pk")],
                                        attrs={"td" : {"style" : "word-break: break-all"},
                                               "th" : {"style" : "width: 13%"}})
    selection       = tables.CheckBoxColumn(accessor="pk",
                                            attrs={"th" : {"style" : "width: 2%"},
                                                   "td__input" : {"name" : "selected_tags"},
                                                   "th__input" : {"type" : "hidden"}})
